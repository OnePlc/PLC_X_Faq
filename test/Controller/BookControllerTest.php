<?php
/**
 * BookControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Book Module
 *
 * @category Test
 * @package Book
...
namespace OnePlaceTest\Book\Controller;

use OnePlace\Book\Controller\BookController;
...
class BookControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/book', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('book');
        $this->assertControllerName(BookController::class); // as specified in router's controller name alias
