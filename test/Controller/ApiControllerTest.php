...
use OnePlace\Book\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/book/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('book-api');
    }
}
